# This program run a MCMC simulation of a skewed normal
# microborst PDF.
import numpy as np
...
if __name__ == '__main__':
    ...
    if not os.path.exists(SAVE_PATH):
        ...
        # Save data
        df = pd.DataFrame(data=trace, columns=['mu', 'sigma', 'a'])
