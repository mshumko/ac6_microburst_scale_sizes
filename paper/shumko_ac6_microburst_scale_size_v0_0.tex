...
TO-DO
\begin{itemize}
\item Discuss how other bin widths and offsets and change these results.
\item Recalculate the CDF uncertainty using a MC model based on the chance coincidence rates for +/- 0.5 L of each event.
\end{itemize}
}
